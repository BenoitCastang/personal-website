...
const bin = document.querySelector('form input:first-of-type');
const hexa = document.querySelector('form input:last-of-type');
if (bin.value < 100) {
...
link.addEventListener('click', function onclick(event) { 
    ...
    console.log('now '+link.getAttribute('style'))
    // link.textContent = 'le loup a faim';
